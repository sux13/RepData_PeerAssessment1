...
```
The mean total number of steps taken per day is **`r meanDaySteps`**.  
The median total number of steps taken per day is **`r medianDaySteps`**.
...
```
The 5-minute interval with the maximum number of average steps taken across all days in dataset is **`r maxInterval`**.
...
```
Total number of missing values in dataset is **`r numMissing`**. 
...
```
The new mean total number of steps taken per day is **`r newMeanDaySteps`**, whereas the previous mean was `r meanDaySteps`.  
The new median total number of steps taken per day is **`r newMedianDaySteps`**, whereas the previous median was `r medianDaySteps`.  
